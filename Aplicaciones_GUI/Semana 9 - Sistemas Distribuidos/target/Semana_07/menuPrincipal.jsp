    ...
    <body>
        ...
        <section class="mb-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6">
                    <a href="EmpleadoServlet?accion=listar" class="menu-link">
                        <div class="card content-card h-100">
                            <div class="card-body">
                                <h2 class="h5">Mantenimiento de empleados</h2>
                                <p class="text-muted mb-0">Gestión completa de empleados: listado, registro, edición y eliminación.</p>
                            </div>
                        </div>
                    </a>
                </div>
